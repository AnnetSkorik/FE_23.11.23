...
//Answer:hello world then 2 seconds
...
//Answer:error, odd, rejected: even
...
//Answer:start, 1, middle, end, success
...
//Answer:1, 2, 4, timerStart, success, timerEnd
...
// 1.11
let promise111 = new Promise(function (resolve, reject) {
  resolve(1)

  setTimeout(() => resolve(2), 1000)
})

promise111.then((data) => console.log(data))
